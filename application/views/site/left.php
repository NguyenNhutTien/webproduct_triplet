	...
	<div class="box-left">
		...
		<div class="content-box">		
			...
			<form class="t-form form_action" method="get" style="padding: 10px"
				action="<?php echo base_url('product/search_price')?>" name="search">

				<div class="form-row">
					<label for="param_price_from" class="form-label"
						style="width: 70px">Giá từ:<span class="req">*</span></label>
				...
				<div class="form-row">
					<label for="param_price_from" class="form-label"
						style="width: 70px">Giá tới:<span class="req">*</span></label>
					<div class="form-item" style="width: 90px">
		...
		<div class="content-box">
			...
			<ul class="catalog-main">
				<?php foreach ($catalog_list as $row):?>
                   <li>
                     <span><a href="<?php echo base_url()?>" title="<?php echo $row['name']?>"><?php echo $row['name']?></a></span>
